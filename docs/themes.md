...
- [ ] T3.1 `one_dark.rb` (Atom One Dark, mode :dark). complexity: [low]
- [ ] T3.2 `one_light.rb` (Atom One Light, mode :light). complexity: [low]
- [ ] T3.3 `gruvbox_dark.rb` (mode :dark). complexity: [low]
- [ ] T3.4 `gruvbox_light.rb` (mode :light). complexity: [low]
- [ ] T3.5 `nord.rb` (mode :dark). complexity: [low]
- [ ] T3.6 `github_dark.rb` (mode :dark). complexity: [low]
- [ ] T3.7 `github_light.rb` (mode :light). complexity: [low]
- [ ] T3.8 `catppuccin_mocha.rb` (dark). complexity: [low]
- [ ] T3.9 `catppuccin_latte.rb` (light). complexity: [low]
- [ ] T3.10 `ayu_dark.rb` (dark). complexity: [low]
- [ ] T3.11 `ayu_light.rb` (light). complexity: [low]
- [ ] T3.12 `ayu_mirage.rb` (dark). complexity: [low]
- [ ] T3.13 `solarized_dark.rb` (dark). complexity: [low]
- [ ] T3.14 `solarized_light.rb` (light). complexity: [low]
- [ ] T3.15 `tomorrow_night.rb` (dark). complexity: [low]
- [ ] T3.16 `tomorrow.rb` (Tomorrow, light). complexity: [low]
- [ ] T3.17 Run `rake pito:themes:export`; commit the regenerated `themes.css`. complexity: [low]
- [ ] T3.18 Spec: every `Registry.all` theme resolves a complete token set + `brand_pito == #5170ff`; `grouped` has the right dark/light split (18 total). complexity: [low]
- [ ] T3.19 Confirm `bin/rails tailwindcss:build` compiles with all 18 blocks. complexity: [low]
- [ ] T3.20 Commit: `P3: 16 remaining theme palettes + regenerate themes.css`. complexity: [manual]
