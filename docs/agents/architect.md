...
- Specs go under `docs/plans/beta/<NN-phase>/specs/<feature>.md` before any
  Lane 1 (rails-impl) / Lane 2 (mcp-impl, cli-impl, website-impl) work fans out.
...
- Editing `CLAUDE.md` directly — route through pito-docs when project-wide
  rules need updating.
