...
#
# Sibling module to `Channels::MockData`. Lives in its own file because
...
#
#   Channels::DemographicsMock.for(channel_id)
#     => { male:   { "13-17" => Int, ..., "65+" => Int },
#          female: { "13-17" => Int, ..., "65+" => Int } }
#
#   Channels::DemographicsMock.aggregate(channels, weighted: false)
...
module Channels
  module DemographicsMock
    ...
    # `Channels::MockData.channels` returns). Returns one
