...
#
# Standalone, independent of Game::MeilisearchIndexer /
# Bundle::MeilisearchIndexer / the Searchable concern. Channel docs
...
class Channel
  class MeilisearchIndexer
    ...
    def call
      ...
      Rails.logger.warn("[Channel::MeilisearchIndexer] upsert failed for channel #{@channel.id}: #{e.class}: #{e.message}")
    end
