      ...
      module InApp
        ...
        def payload_for(notification)
...

          {
            ...
            url:               template.url,
            severity:          severity,
            severity_class:    Pito::Notifications::Formatter::IN_APP_SEVERITY_CLASSES.fetch(severity, "notification-info"),
            glyph:             Pito::Notifications::Formatter.emoji_for(notification.event_type),
            kind:              notification.event_type.to_s,
            fires_at_relative: Pito::Notifications::Formatter.format_timestamp(notification.fires_at, :relative),
            fires_at_iso:      Pito::Notifications::Formatter.format_timestamp(notification.fires_at, :iso),
