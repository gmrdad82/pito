      ...
      class Slack < Base
        ...
        def enabled?
          ...
          unless deliverable_url?(url)
            Rails.logger.warn(
              "Pito::Notifications::DeliveryChannel::Slack disabled: " \
        ...
        def payload_for(notification)
          if defined?(Pito::Notifications::Formatter::Slack)
            Pito::Notifications::Formatter::Slack.payload_for(notification)
          else
