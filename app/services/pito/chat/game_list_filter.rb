...
module Pito
  module Chat
    ...
    #   config/pito/verbs.yml (exposed via Pito::Grammar::Registry). That is the
    ...
    module GameListFilter
      ...
      class << self
        ...
        # no genre/platform/`upcoming`/noun/verb and was not consumed as part of a
        ...
        # alias, platform synonym, `upcoming`, the verb, a listable noun, or one
        ...
        def walk(tokens)
          ...
          while i < tokens.length
            ...
            if bigram && (subs = platform_synonyms[bigram])
              ...
              # recognized verb/noun — consumed, neither a filter nor a typo.
              i += 1
            else
              leftover << single
              i += 1
