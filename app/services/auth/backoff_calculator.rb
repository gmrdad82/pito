...
# Contract:
#
#     Auth::BackoffCalculator.record_trip!(key: "ip:1.2.3.4")
...
#
#     Auth::BackoffCalculator.seconds_remaining(key: "ip:1.2.3.4")
#       => Integer (seconds until the bucket clears, 0 if clear)
#
#     Auth::BackoffCalculator.reset!(key: "ip:1.2.3.4")
...
module Auth
  class BackoffCalculator
    ...
    def self.record_trip!(key:)
      ...
      Rails.logger.warn("[Auth::BackoffCalculator] record_trip! failed: #{e.class}: #{e.message}")
      BASE_BACKOFF
    end
