...
module Pito
  module Analytics
    module Metric
      ...
      # (BaseComponent). Each bar is 2 rows tall (identical glyph rows), with a
      ...
      #   caption: pre-rendered html-safe caption (passed through to BaseComponent)
      #
      ...
      class BarChartComponent < BaseComponent
        ...
        # never pulse in sync (mirrors HeartChartComponent#shimmer_offset_class).
