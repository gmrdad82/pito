...
module Pito
  module Shell
    module Chatbox
      ...
      # counter — the name moved there from the chatbox; the Chatbox::
      ...
      # and collapses back to the header spacer when cleared. This component
      # MUST stay mounted inside ContextMeterComponent — when the meter
      # rendered a bare span instead, broadcast_conversation_name replaced a
      # ghost id and renames only showed after a reload.
