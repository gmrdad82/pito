...
RSpec.describe NotificationDeliveryChannel do
  let(:notification) { create(:notification) }

  describe ".for" do
    it "returns Discord for 'discord'" do
      expect(NotificationDeliveryChannel.for("discord")).to be_a(NotificationDeliveryChannel::Discord)
    end

    it "returns Slack for 'slack'" do
      expect(NotificationDeliveryChannel.for("slack")).to be_a(NotificationDeliveryChannel::Slack)
    end

    it "returns InApp for 'in_app'" do
      expect(NotificationDeliveryChannel.for("in_app")).to be_a(NotificationDeliveryChannel::InApp)
    end
