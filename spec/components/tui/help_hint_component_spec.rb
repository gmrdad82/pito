...
RSpec.describe Tui::HelpHintComponent, type: :component do
  before { render_inline(described_class.new) }

  it "renders the help key glyph" do
    expect(page).to have_css("span.bsb-hint-key", text: I18n.t("tui.bst.help_key"))
  end

  it "renders the help label" do
    expect(page).to have_css("span.bsb-hint-label")
    expect(page).to have_text(I18n.t("tui.bst.help_label"))
  end
