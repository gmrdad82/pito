...
RSpec.describe Pito::Analytics::Metric::BarChartComponent, type: :component do
  COLS = Pito::Analytics::Metric::BaseComponent::COLS # 45
  ROWS = Pito::Analytics::Metric::BaseComponent::ROWS # 11
  ...
  it "floors the last bg row with the baseline dot (⣀)" do
    ...
    expect(bg_rows.last.text).to include(Pito::Analytics::Metric::BaseComponent::BASELINE_DOT)
  end
