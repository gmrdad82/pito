# Gaming Recording & Editing Pipeline

## Recording

- **Software:** OBS
- **Platforms:** PS5 Pro, Switch 2, Steam
- **Audio tracks:** 2 separate tracks
  1. Gameplay audio
  2. Voiceover (live commentary when something cool happens or the urge strikes)

## Editing (DaVinci Resolve)

1. **Import** all footage into DaVinci timeline
2. **Rough cut** — cut around voiceover segments which act as markers/cues
