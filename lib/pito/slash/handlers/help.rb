...
module Pito
  module Slash
    module Handlers
      ...
      #
      # The slash grammar declares `auth: any` (config/pito/tools.yml) so the
      ...
      class Help < Pito::Slash::Handler
        ...
        # Grammar (auth :any, dispatch): config/pito/tools.yml. The handler
        ...
        # tools appear automatically — no manual YAML sync required.
        def slash_section
