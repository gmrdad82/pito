...
module Pito
  module FollowUp
    module Handlers
      ...
      # unlink tool can identify which game to unlink from without the user
      ...
      #
      #   #<handle> unlink <id>
      #     → Delegated to Chat::Handlers::Unlink via ToolDelegator. The
      ...
      class GameLinkedVideos < Pito::FollowUp::Handler
        ...
        def call(event:, rest:, conversation:, period: nil, viewport_width: nil, channel: nil)
          ...
          when "unlink"
            # ToolDelegator with the original source event: reply_target
            ...
            Pito::FollowUp::ToolDelegator.call(
              source_event:   event,
              rest:           rest,
              conversation:   conversation,
              period:         period,
