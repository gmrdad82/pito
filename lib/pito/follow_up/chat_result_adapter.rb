...
module Pito
  module FollowUp
    # Adapts a tool handler's `Pito::Chat::Result` into a `Pito::FollowUp::Result`.
    # This is what lets ONE tool handler serve both entry
    ...
    # Confirmable tool needs no special case — its Ok already carries a
