...
module Pito
  module Dispatch
    ...
    # tool reached via a `#<handle>` reply persists + completes IDENTICALLY to the
    # same tool typed in free chat.
    #
    ...
    class Finalizer
      ...
      # message — a chat tool or a reply-that-appends — supersedes old affordances,
      ...
      # universal share/revoke/unshare tools work on any addressed message.
      ...
      #   chat tool, and any reply that consumes its source), a new
      ...
      def persist(events:, turn:, retire_prior_hashtags: true)
        ...
        # uniformly to typed chat tools AND replies-that-append (a progression). Mutate
