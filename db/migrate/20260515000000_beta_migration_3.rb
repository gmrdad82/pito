class BetaMigration3 < ActiveRecord::Migration[8.1]
  def change
    # Extensions ------------------------------------------------------------
    ...
    # Enum types ------------------------------------------------------------
    create_enum "analytics_window", %w[7d 28d 90d lifetime]
    ...
    # Companies / Games / Genres / Platforms -------------------------------
